...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 04, 2023 at 08:42 AM
...
INSERT INTO `application` (`applicationid`, `studentid`, `sportid`, `tryoutid`, `approvalstatus`) VALUES
(1000, 2223905, 3, 3284, 'Denied'),
(1001, 2221213, 7, 1417, 'Qualified'),
(2000, 2201234, 5, 3255, 'Pending'),
(2001, 2212121, 1, 6446, 'Qualified'),
(3000, 2235432, 1, 3005, 'Denied'),
(3001, 2202020, 2, 7543, 'Qualified');
